...
import { getPromoCodes } from '../../../admin/actions';
import { PromoCodesClientPage } from '../PromoCodesClientPage';
import { SidebarTrigger } from '@/components/ui/sidebar';

export const revalidate = 0; // Ensure dynamic rendering

// This page now reuses the main client page.
// The client page will check the route and open the "Add New" modal automatically.
