...
export function AdminNav() {
    ...
    const isAppointmentsActive = pathname.startsWith('/admin/dashboard/appointments');
    const isBlogsActive = pathname.startsWith('/admin/dashboard/blogs');
    const isPromoCodesActive = pathname.startsWith('/admin/dashboard/promocodes');
    const isCounselorsActive = pathname.startsWith('/admin/dashboard/counselors');
    ...
    const baseNavLinks = [
        ...
        { href: '/admin/dashboard/clients', label: 'Clients', icon: <Users />, active: pathname.startsWith('/admin/dashboard/clients') },
    ];

    const appointmentSubLinks = [
        { href: '/admin/dashboard/appointments', label: 'All Appointments', icon: <List /> },
        { href: '/admin/dashboard/appointments/new', label: 'Book Appointment', icon: <PlusCircle /> },
    ];

    const blogSubLinks = [
        { href: '/admin/dashboard/blogs', label: 'All Posts', icon: <List /> },
        { href: '/admin/dashboard/blogs/new', label: 'Add New', icon: <PlusCircle /> },
        { href: '/admin/dashboard/blogs/categories', label: 'Categories', icon: <LayoutList /> },
    ];

    const promoCodeSubLinks = [
        { href: '/admin/dashboard/promocodes', label: 'All Codes', icon: <List /> },
        { href: '/admin/dashboard/promocodes/new', label: 'Add New', icon: <PlusCircle /> },
    ];

    const counselorSubLinks = [
        { href: '/admin/dashboard/counselors', label: 'All Counselors', icon: <List /> },
        { href: '/admin/dashboard/counselors/new', label: 'Add New', icon: <PlusCircle /> },
    ];
